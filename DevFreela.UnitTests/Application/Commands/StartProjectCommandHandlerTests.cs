...
namespace DevFreela.UnitTests.Application.Commands
{
    ...
    {
        [Fact]
        public async void ProjectIdExists_Executed_StartProject()
        {
            //
            // Arrange
            ...
            var command = new StartProjectCommand(It.IsAny<int>());
            var handler = new StartProjectCommandHandler(mock.Object);
